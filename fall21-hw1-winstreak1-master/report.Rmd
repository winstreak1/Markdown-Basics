...
![Sales in the East](https://user-images.githubusercontent.com/17502942/132419639-8c75b817-97ac-4728-97ae-b9d181aca48d.png)
...
3. *Replace `count()` with `average("Miles_per_Gallon")`.*
     ...
     The scatterplot forms a straight, linear line that has a slope of 1/1.
